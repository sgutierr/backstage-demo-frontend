...
const EntityGroupProfileCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-9b2886ba.esm.js').then((m) => m.GroupProfileCard)
    }
  })
);
const EntityMembersListCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-9b2886ba.esm.js').then((m) => m.MembersListCard)
    }
  })
);
const EntityOwnershipCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-9b2886ba.esm.js').then((m) => m.OwnershipCard)
    }
  })
);
const EntityUserProfileCard = orgPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-9b2886ba.esm.js').then((m) => m.UserProfileCard)
    }
  })
);
