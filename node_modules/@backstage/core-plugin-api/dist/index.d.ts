...
declare function withApis<T extends {}>(apis: TypesToApiRefs<T>): <TProps extends T>(WrappedComponent: React$1.ComponentType<TProps>) => {
    (props: React$1.PropsWithChildren<Omit<TProps, keyof T>>): JSX.Element;
    displayName: string;
};
 ...
 * @public
 */
type ParamKeys<Params extends AnyParams> = keyof Params extends never ? [] : (keyof Params)[];
/**
 ...
 * @public
 */
type BackstagePlugin<Routes extends AnyRoutes = {}, ExternalRoutes extends AnyExternalRoutes = {}, PluginInputOptions extends {} = {}> = {
    getId(): string;
 ...
 * @public
 */
type PluginConfig<Routes extends AnyRoutes, ExternalRoutes extends AnyExternalRoutes, PluginInputOptions extends {}> = {
    id: string;
