...
const EntityLatestGithubActionRunCard = githubActionsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-a835c190.esm.js').then((m) => m.LatestWorkflowRunCard)
    }
  })
);
const EntityLatestGithubActionsForBranchCard = githubActionsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-a835c190.esm.js').then(
...
const EntityRecentGithubActionsRunsCard = githubActionsPlugin.provide(
  createComponentExtension({
    ...
    component: {
      lazy: () => import('./esm/index-a835c190.esm.js').then((m) => m.RecentWorkflowRunsCard)
    }
  })
);
